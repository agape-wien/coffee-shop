...
echo ""
echo "=== Adding agapewien to the docker group ==="
# The systemd service runs autoupdate.sh as agapewien.
...
usermod -aG docker agapewien
echo "agapewien added to docker group."
