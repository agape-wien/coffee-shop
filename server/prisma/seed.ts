...
async function main() {
  ...
  // Clear existing data in foreign-key order so constraints are never violated.
  // This is a dev-only reset — running the seed twice gives a clean slate.
  ...
  // ── Coffee items ─────────────────────────────────────────────────────────────
  // ee = espresso-equivalent portions (1 = one 7g dose / one shot)
  // me = milk-equivalent ml used when steaming

  await prisma.menuItem.createMany({
    data: [
      {
        name: 'Espresso',
        description: 'Single shot — intense and concentrated',
        categoryId: coffee.id, type: ItemType.COFFEE,
        ee: 1, me: 0, sortOrder: 0,
      },
      {
        name: 'Doppio',
        description: 'Double espresso shot',
        categoryId: coffee.id, type: ItemType.COFFEE,
        ee: 2, me: 0, sortOrder: 1,
      },
      {
        name: 'Americano',
        description: 'Espresso lengthened with hot water',
        categoryId: coffee.id, type: ItemType.COFFEE,
        ee: 1, me: 0, sortOrder: 2,
      },
      {
        name: 'Cappuccino',
        description: 'Espresso with steamed milk and thick foam',
        categoryId: coffee.id, type: ItemType.COFFEE,
        ee: 1, me: 120, sortOrder: 3,
      },
      {
        name: 'Latte',
        description: 'Espresso with a generous pour of steamed milk',
        categoryId: coffee.id, type: ItemType.COFFEE,
        ee: 1, me: 200, sortOrder: 4,
      },
      {
        name: 'Flat White',
        description: 'Double ristretto with velvety microfoam',
        categoryId: coffee.id, type: ItemType.COFFEE,
        ee: 2, me: 150, sortOrder: 5,
      },
      {
        name: 'Macchiato',
        description: 'Espresso with a small mark of steamed milk',
        categoryId: coffee.id, type: ItemType.COFFEE,
        ee: 1, me: 30, sortOrder: 6,
      },
    ],
  })
    ...
    data: [
      {
        ...
        description: 'Classic black tea — milk served on the side',
        categoryId: other.id, type: ItemType.OTHER,
        ee: 0, me: 0, sortOrder: 0,
      },
      {
        name: 'Green Tea',
        description: 'Light and delicate',
        categoryId: other.id, type: ItemType.OTHER,
        ee: 0, me: 0, sortOrder: 1,
      },
      {
        name: 'Hot Chocolate',
        description: 'Rich cocoa with steamed milk',
        categoryId: other.id, type: ItemType.OTHER,
        ee: 0, me: 200, sortOrder: 2,
      },
      {
        name: 'Orange Juice',
        description: 'Freshly squeezed',
        categoryId: other.id, type: ItemType.OTHER,
        ee: 0, me: 0, sortOrder: 3,
      },
      {
        name: 'Sparkling Water',
        description: '330 ml bottle',
        categoryId: other.id, type: ItemType.OTHER,
        ee: 0, me: 0, sortOrder: 4,
      },
    ],
  })
